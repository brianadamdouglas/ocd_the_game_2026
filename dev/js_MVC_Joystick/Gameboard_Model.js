...
*/
var Gameboard_Model = Class.extend({
/**
* Constructor
*/
construct: function() { 
	...
	this._thoughtAnimations// = new Array();
	this._startScreenElements// = new Array();
	this._instructionElements// = new Array();
	this._disclaimerElements// = new Array();
	this._loadTotal// = 0;
	...
	this._goodEndScreenElements// = new Array();
	this._badEndScreenElements// = new Array();
	this._joystickElements;
...
init: function(){
	...
	this._goodEndScreenElements = new Array();
	this._badEndScreenElements = new Array();
	this._joystickElements = new Array();
	this._loadTotal = 0;
	this._stageBuilder = new StageBuilder();
	this._lastBuildNum = 0;
...
* @param {Object} data 
*/	
addJoystickElement:function(data){
	this._lastBuildNum = this._stageBuilder.addElement(data, this._joystickElements, 'goodEndScreen');
},
...
generateThoughtInfo:function(){
	this._thoughtInfo = {type:'thoughtBubble', x:this._rotaterX - 87, y:this._rotaterY - 215, w:179, h:168, stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]}};
},
...
generateGoodEndScreenElements:function(){
	var paddingX = (g_screenWidth - 375)/2;
	var paddingY = (g_screenHeight - 559)/2;
	this.addGoodEndScreenElement({type:'endScreenGood', x:(paddingX + 0), y:(paddingY + 0), w:375, h:559, IDOverride:"goodEndScreenBackground"});
	this.addGoodEndScreenElement({type:'endScreenGoodButton', x:(paddingX + 95), y:(paddingY + 244), w:187, h:41, IDOverride:"goodEndScreenButton", buttonFunction:"buttonEvent"});
...
generateBadEndScreenElements:function(){
	var paddingX = (g_screenWidth - 375)/2;
	var paddingY = (g_screenHeight - 559)/2;
	this.addBadEndScreenElement({type:'endScreenBad', x:(paddingX + 0), y:(paddingY + 0), w:375, h:559, IDOverride:"badEndScreenBackground"});
	this.addBadEndScreenElement({type:'endScreenBadButton', x:(paddingX + 77), y:(paddingY + 250), w:221, h:33, IDOverride:"badEndScreenButton", buttonFunction:"buttonEvent"});
	/* this._endScreenInfo = {type:'endScreen', x:0, y:0, w:375, h:559}; */
},

generateJoystickElements:function(){
	var paddingX = 10;
	var paddingY = g_screenHeight - 10;//(g_screenHeight - 559)/2;
	this.addJoystickElement({type:'joystickButtonU', x:(paddingX + 51), y:(paddingY - 150), w:47, h:47, IDOverride:"joystickUp" , downFunction:"joystickUpDown", pressFunction:"joystickUpPressed", releaseFunction:"joystickUpReleased"});
	this.addJoystickElement({type:'joystickButtonL', x:(paddingX + 0), y:(paddingY - 98), w:47, h:47, IDOverride:"joystickLeft", downFunction:"joystickLeftDown" , releaseFunction:"joystickUpReleased"});
	this.addJoystickElement({type:'joystickButtonD', x:(paddingX + 51), y:(paddingY -47), w:47, h:47, IDOverride:"joystickDown" , downFunction:"joystickDownDown", releaseFunction:"joystickUpReleased"});
	this.addJoystickElement({type:'joystickButtonR', x:(paddingX + 103), y:(paddingY -98), w:47, h:47, IDOverride:"joystickRight" , downFunction:"joystickRightDown", releaseFunction:"joystickUpReleased"});
	this.addJoystickElement({type:'joystickButtonA', x:(g_screenWidth -150), y:(paddingY - 98), w:47, h:47, IDOverride:"buttonA" , downFunction:"buttonADown", releaseFunction:"joystickUpReleased"});
	this.addJoystickElement({type:'joystickButtonB', x:(g_screenWidth -61), y:(paddingY -98), w:47, h:47, IDOverride:"buttonB" , downFunction:"buttonBDown", releaseFunction:"joystickUpReleased"});
},
...
generateStartScreenElements:function (){
	var paddingX = (g_screenWidth - 375)/2;
	var paddingY = (g_screenHeight - 559)/2;
	this.addStartScreenElement({type:'logo', x:(paddingX + 27), y:(paddingY + 25), w:321, h:301});
	this.addStartScreenElement({type:'loading', x:(paddingX + 120), y:(paddingY + 375), w:154, h:23, IDOverride:"loading"});
	this.addStartScreenElement({type:'startButton', x:(paddingX + 139), y:(paddingY + 375), w:90, h:23, IDOverride:"start", buttonFunction:"startGame"});
	/* this.addStartScreenElement({type:'instructionsButton', x:(paddingX + 83), y:(paddingY + 391), w:201, h:23, IDOverride:"instructions", buttonFunction:"openInstructions"}); */
	this.addStartScreenElement({type:'disclaimerButton', x:(paddingX + 96), y:(paddingY + 415), w:175, h:23, IDOverride:"disclaimer", buttonFunction:"openDisclaimer"});
	this.addStartScreenElement({type:'trademark', x:(paddingX + 31), y:(paddingY + 470), w:306, h:39});
	
	/* this.addInstructionsElement({type:'instructionImages', x:(paddingX + 0), y:(paddingY + 0), w:319, h:508});
	this.addInstructionsElement({type:'instructionButtonBack', x:(paddingX + 3), y:(paddingY + 457), w:58, h:47, IDOverride:"back", buttonFunction:"previousPanel"});
	this.addInstructionsElement({type:'instructionButtonForward', x:(paddingX + 258), y:(paddingY + 457), w:58, h:47, IDOverride:"forward", buttonFunction:"nextPanel"});
	this.addInstructionsElement({type:'menuClose', x:(paddingX + 258), y:(paddingY + 3), w:58, h:47, IDOverride:"close", buttonFunction:"close"}); */
	
	this.addDisclaimerElement({type:'disclaimerImage', x:(paddingX + 0), y:(paddingY + 0), w:319, h:508});
	this.addDisclaimerElement({type:'menuClose', x:(paddingX + 258), y:(paddingY + 3), w:58, h:47, IDOverride:"close", buttonFunction:"close"});
},
...
generateStageElements:function (){
	...
	this.addStageElement({type:'sidewalk', x:918, y:-490, w:100, h:900});
	...
	this.addStageElement({type:'innerwallV', x:656, y:20, w:20, h:50});
	this.addStageElement({type:'innerwallV', x:656, y:70, w:20, h:98});
	this.addStageElement({type:'innerwallCapDTopWall', x:656, y:168, w:20, h:75});////
	...
	this.addStageElement({type:'innerwallCapUBathroomBottom1', x:755, y:804, w:20, h:74});////
	...
	this.addStageElement({type:'brCloset1', x:778, y:220, w:62, h:100});
	this.addStageElement({type:'brCloset2', x:778, y:320, w:62, h:88});
	this.addStageElement({type:'livingroomPlant', x:22, y:22, w:71, h:75});
	...
	this.addStageElement({type:'towels1', x:775, y:639, w:27, h:100});
	this.addStageElement({type:'towels2', x:775, y:739, w:27, h:100});
	this.addStageElement({type:'towels3', x:775, y:839, w:27, h:19});
	...
	/* LIVING ROOM CLOSET */
	this.addStageElement({type:'lrCloset1', x:1059, y:956, w:100, h:62});
	this.addStageElement({type:'lrCloset2', x:1159, y:956, w:73, h:62});
	...
	this.addStageElement({type:'door90Deg', x:477, y:548, w:100, h:22, listener:'tile' + this._lastBuildNum, state:false});
	...
	// bedroom closet
	this.addStageElement({type:'door90Deg', x:565, y:237, w:100, h:22, listener:'tile' + (this._lastBuildNum + 2), state:false});
	this.addStageElement({type:'door180Deg', x:655, y:243, w:22, h:100, listener:'tile' + this._lastBuildNum, state:true});
	
	// hall closet
	this.addStageElement({type:'door90Deg', x:663, y:698, w:100, h:22, listener:'tile' + (this._lastBuildNum + 2), state:false});
	this.addStageElement({type:'door180Deg', x:753, y:704, w:22, h:100, listener:'tile' + this._lastBuildNum, state:true});
	...
	this.addStageElement({type:'nightstand', x:490, y:20, w:80, h:60});
	this.addStageElement({type:'plug2', x:570, y:20, w:40, h:10, listener:'tile' + this._lastBuildNum, thoughtType:'lampBR', objectType:"immobile"});
	...
	this.addStageElement({type:'kitchenChairRight', x:112, y:1137, w:78, h:60, moveObject:{x:4, y:4, xMax:20, yMax:100, xMin:-10, yMin:-100, up:true, down:true, left:true, right:true},thoughtType:'chairTable', objectType:"mobile"});
	this.addStageElement({type:'kitchenChairLeft', x:379, y:1165, w:78, h:60, moveObject:{x:4, y:4, xMax:24, yMax:100, xMin:-44, yMin:-100, up:true, down:true, left:true, right:true},thoughtType:'chairTable', objectType:"mobile"});
	...
	this.addStageElement({type:'pants', x:190, y:200, w:46, h:37,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'pant', objectType:"sticky"});//w:19, h:24
	this.addStageElement({type:'underwear', x:705, y:247, w:48, h:25,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'underwear', objectType:"sticky"});//w:19, h:24
	...
	this.addStageElement({type:'bathWaterTrigger', x:1065, y:695, w:100, h:100,listener:'tile' + this._lastBuildNum, thoughtType:'bathtub', objectType:"immobile"});
	this.addStageElement({type:'bathWaterTrigger', x:1065, y:800, w:100, h:100,listener:'tile' + (this._lastBuildNum - 1), thoughtType:'bathtub', objectType:"immobile"});
	...
	this.addStageElement({type:'bathWaterTrigger', x:820, y:725, w:80, h:75,listener:'tile' + this._lastBuildNum, thoughtType:'bathSink', objectType:"immobile"});
...
generateThoughtElements:function (){
	/* THOUGHT ANIMATIONS*/
	this.addThoughtElement({name:'candle', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "candleThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'lampBR', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "lampBRThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'lampOffice', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "lampOfficeThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'bookOffice', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "bookOfficeThought/animation", frameType:".gif", className:"animationSequence"});
	this.addThoughtElement({name:'chairBar', x:11, y:8, w:157, h:116, frameCount:6, frameRoot:this._directory + "chairBarThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'chairTable', x:11, y:8, w:157, h:116, frameCount:4, frameRoot:this._directory + "chairTableThought/animation", frameType:".gif", className:"animationSequence"});
	this.addThoughtElement({name:'matCorner', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "matCornerThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'kitchenSink', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "kitchenSinkThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'kitchenRange', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "kitchenRangeThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'frontDoor', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "frontDoorThought/animation", frameType:".gif", className:"animationSequence"});
	this.addThoughtElement({name:'tv', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "tvThought/animation", frameType:".gif", className:"animationSequence"});
	this.addThoughtElement({name:'lampLR', x:11, y:8, w:157, h:116, frameCount:4, frameRoot:this._directory + "lampLRThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'toilet', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "toiletThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'bathtub', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "bathtubThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'bathSink', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "bathSinkThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'sock', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "sockThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'underwear', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "underwearThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'shirt', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "shirtThought/animation", frameType:".gif", className:"animationSequence"}); //complete
	this.addThoughtElement({name:'pant', x:11, y:8, w:157, h:116, frameCount:3, frameRoot:this._directory + "pantThought/animation", frameType:".gif", className:"animationSequence"}); //complete
},
...
//Lookup table for classes associated with parts of the gameBoard
	this._gameBoardClasses = {
		...
		plug2:"obstacle interactive OnOffTileController",
		bed1:"obstacle",
		bed2:"obstacle",
		bed3:"obstacle",
		bed4:"obstacle",
		...
		joystickButtonU:"button",
		joystickButtonD:"button",
		joystickButtonL:"button",
		joystickButtonR:"button",
		joystickButtonA:"button",
		joystickButtonB:"button",
		towels1:"obstacle",
		towels2:"obstacle",
		towels3:"obstacle",
		lrCloset1:"obstacle",
...
setGameboardImageLookup:function(){
	this._gameBoardImageLookup = {
		...
		thoughtBubble:this._directory + "thoughts.png",
		...
		plug2:[this._directory + "plugInRight.gif",this._directory + "plugOutRight.gif"],
		...
		joystickButtonU:this._directory + "joystickButtonU.png",
		joystickButtonD:this._directory + "joystickButtonD.png",
		joystickButtonL:this._directory + "joystickButtonL.png",
		joystickButtonR:this._directory + "joystickButtonR.png",
		joystickButtonA:this._directory + "joystickButtonA.png",
		joystickButtonB:this._directory + "joystickButtonB.png",
		towels1:this._directory + "towels1.gif",
		towels2:this._directory + "towels2.gif",
		towels3:this._directory + "towels3.gif",
		lrCloset1:this._directory + "LRcloset1.gif",
		lrCloset2:this._directory + "LRcloset2.gif",
		brCloset1:this._directory + "BRcloset1.gif",
		brCloset2:this._directory + "BRcloset2.gif"
...
getJoystickElements:function(){
	return this._joystickElements;
},
