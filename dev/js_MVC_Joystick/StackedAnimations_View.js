var StackedAnimations_View = NonGraphic_View.extend({ // also used for the rotater div , perhaps I should rename this.
/**
* Constructor
...
addAnimationSequence: function(data){ //name, id, className, x, y, width, height, imgs, startFrame
    var newController = new ThoughtAnimationSequence_Controller();
