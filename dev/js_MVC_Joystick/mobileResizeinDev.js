	...
	if(event != undefined){
		...
		if(event.orientation == "portrait"){
			...
			if(orientation == "portrait"){
				...
				var screenHeight = 559//screen.height;
			}
		    //place player
	        ...
	        var leftX = Math.floor((screen.height- 559)/2);
	        var topY = Math.floor((screen.width- 375)/2);
	        g_eventHandler.dispatchAnEvent("screenRotatedLandscape",{});
	        g_rotateScreen._rotateScreen.setViewLoc(leftX,topY);
...
//get the screen width and the screen height;
