...
g_gameboardModel.setInitialLoadBytes(37102);
g_gameboardModel.setTotalLoadBytes(499977);
...
function g_afterAssetsLoad(){
	...
	//g_touchController.init(g_mainGameController, g_mainGameController.getPlayer(), g_mainGameController.getStage(), false); 
