...
/*PUT GAME BOARD GLOBALS HERE*/
			...
			*/	
			...
			addStartScreenElement({type:'logo', x:27, y:25, w:321, h:301});
			addStartScreenElement({type:'loading', x:120, y:342, w:154, h:23, IDOverride:"loading"});
			addStartScreenElement({type:'startButton', x:139, y:342, w:90, h:23, IDOverride:"start", buttonFunction:"startGame"});
			addStartScreenElement({type:'instructionsButton', x:83, y:391, w:201, h:23, IDOverride:"instructions", buttonFunction:"openInstructions"});
			addStartScreenElement({type:'disclaimerButton', x:96, y:444, w:175, h:23, IDOverride:"disclaimer", buttonFunction:"openDisclaimer"});
...
/* OUTDOORS */		
			...
			addStageElement({type:'dirt', x:793, y:0, w:70, h:210});
			addStageElement({type:'dirt', x:863, y:0, w:61, h:408});
			addStageElement({type:'dirt', x:1018, y:0, w:182, h:408});
			addStageElement({type:'shrubbery', x:803, y:15, w:66, h:45});
			addStageElement({type:'shrubbery', x:869, y:15, w:45, h:100});
			addStageElement({type:'shrubbery', x:869, y:115, w:45, h:100});
			addStageElement({type:'shrubbery', x:869, y:215, w:45, h:100});
			addStageElement({type:'shrubbery', x:869, y:315, w:45, h:85});
			
			addStageElement({type:'shrubbery', x:1021, y:15, w:45, h:100});
			addStageElement({type:'shrubbery', x:1021, y:115, w:45, h:100});
			addStageElement({type:'shrubbery', x:1021, y:215, w:45, h:100});
			addStageElement({type:'shrubbery', x:1021, y:315, w:45, h:85});
			addStageElement({type:'shrubbery', x:1066, y:15, w:100, h:45});
			addStageElement({type:'shrubbery', x:1166, y:15, w:23, h:45});
			
			addStageElement({type:'sidewalk', x:918, y:-290, w:100, h:700});
			addStageElement({type:'finishText', x:924, y:113, w:88, h:15});
			addStageElement({type:'exitGameBlocker', x:918, y:0, w:100, h:10});
...
/* BATHROOM FLOOR TILE */			
			...
			addStageElement({type:'bathroomCounterTile', x:822, y:655, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:862, y:655, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:822, y:695, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:862, y:695, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:822, y:735, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:862, y:735, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:822, y:775, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:862, y:775, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:822, y:815, w:40, h:40});
			addStageElement({type:'bathroomCounterTile', x:862, y:815, w:40, h:40});
			...
			addStageElement({type:'outerwallT', x:600, y:0, w:56, h:20}); // this is the problematic tile
			...
			addStageElement({type:'innerwallCapDBathroomTop2', x:802, y:654, w:20, h:79});
			...
			addStageElement({type:'toiletBack', x:927, y:1056, w:62, h:28});
			
			
			addStageElement({type:'garbageCan', x:798, y:885, w:40, h:40}); 
			...
			addStageElement({type:'dropTarget', x:680, y:40, w:90, h:75, IDOverride:"hamper", dropTargetFunction:"dropTargetHamper"});
			addStageElement({type:'dropTarget', x:520, y:1410, w:47, h:57, IDOverride:"bookcase", dropTargetFunction:"dropTargetBookcase"});
		...
		//	addStageElement({type:'interactButton', x:0, y:0, w:g_stageWidth, h:g_stageHeight, IDOverride:"swipeInterface"});
			...
			addStageElement({type:'door90Deg', x:918, y:407, w:100, h:22, listener:'tile' + (lastBuildNum + 2), state:true, thoughtType:'frontDoor',objectType:"immobile"});
			addStageElement({type:'door0Deg', x:1001, y:312, w:22, h:100, listener:'tile' + lastBuildNum, state:false, thoughtType:'frontDoor', objectType:"immobile"});		
			...
			addStageElement({type:'plug', x:150, y:20, w:40, h:10, listener:'tile' + lastBuildNum, thoughtType:'lampBR', objectType:"immobile"});
			addStageElement({type:'bedroomCandle', x:334, y:535, w:28, h:28, thoughtType:'candle', objectType:"immobile"}); //, startFrame:1
			/* KITCHEN */
			addStageElement({type:'range', x:360, y:650, w:100, h:66});
			addStageElement({type:'rangeController', x:360, y:720, w:100, h:12,listener:'tile' + lastBuildNum, thoughtType:'kitchenRange', objectType:"immobile"});
			addStageElement({type:'kitchenMat7', x:432, y:825, w:24, h:25, thoughtType:'matCorner', objectType:"immobile"});
			addStageElement({type:'kitchenSinkWater', x:270, y:810, w:50, h:46, thoughtType:'kitchenSink', objectType:"immobile"});
			addStageElement({type:'barStoolHorz', x:160, y:920, w:61, h:53, moveObject:{x:5, y:5, xMax:0, yMax:30, up:true, down:false, left:false, right:false},thoughtType:'chairBar', objectType:"mobile"});
			...
			addStageElement({type:'kitchenChairRight', x:112, y:1137, w:78, h:60, moveObject:{x:4, y:4, xMax:16, yMax:30, up:true, down:true, left:true, right:true},thoughtType:'chairTable', objectType:"mobile"});
			addStageElement({type:'kitchenChairLeft', x:387, y:1121, w:78, h:60, moveObject:{x:4, y:4, xMax:16, yMax:30, up:true, down:true, left:true, right:true},thoughtType:'chairTable', objectType:"mobile"});
			...
			/* LIVING ROOM */
			addStageElement({type:'tvFront', x:880, y:1158, w:112, h:11, thoughtType:'tv', objectType:"immobile"});
			addStageElement({type:'tvRemote', x:982, y:1179, w:30, h:30 ,listener:'tile' + lastBuildNum, thoughtType:'tv', objectType:"sticky", stickyHoldingOffset:{0:[-3,1], 90:[-2,6], 180:[3,-1], 270:[-8,3]}});//x:982, y:1179
			addStageElement({type:'sofaEndTable1Interact', x:662, y:1537, w:98, h:98, thoughtType:'lampLR', objectType:"immobile"});
			addStageElement({type:'sofaEndTable1Interact', x:1100, y:1537, w:98, h:98, thoughtType:'lampLR', objectType:"immobile"});
			/* OFFICE */
			addStageElement({type:'desk5', x:295, y:1428, w:80, h:80, thoughtType:'lampOffice', objectType:"immobile"});
			
			
			addStageElement({type:'sock', x:720, y:250, w:30, h:30,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'sock', objectType:"sticky"});//w:19, h:24
			addStageElement({type:'sock', x:734, y:187, w:30, h:30,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'sock', objectType:"sticky"});//w:19, h:24
			addStageElement({type:'pants', x:689, y:230, w:46, h:37,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'pant', objectType:"sticky"});//w:19, h:24
			addStageElement({type:'underwear', x:718, y:247, w:48, h:25,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'underwear', objectType:"sticky"});//w:19, h:24
			addStageElement({type:'shirt', x:695, y:200, w:66, h:39,stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]},thoughtType:'shirt', objectType:"sticky"});//w:19, h:24
			
			addStageElement({type:'book', x:108, y:1480, w:39, h:39,stickyHoldingOffset:{0:[-20,-10], 90:[20,-10], 180:[20,10], 270:[-20,10]},thoughtType:'bookOffice', objectType:"sticky"});//x:187, y:1460
			
			addStageElement({type:'bathWater', x:1065, y:693, w:96, h:200});
			addStageElement({type:'bathWaterTrigger', x:1065, y:703, w:30, h:80,listener:'tile' + lastBuildNum, thoughtType:'bathtub', objectType:"immobile"});
			addStageElement({type:'bathroomTubFaucet', x:1098, y:668, w:36, h:28});
			
			addStageElement({type:'bathroomSink', x:839, y:725, w:39, h:71});
			addStageElement({type:'bathWaterTrigger', x:870, y:743, w:30, h:342,listener:'tile' + lastBuildNum, thoughtType:'bathSink', objectType:"immobile"});
			addStageElement({type:'bathroomSinkFixtures', x:802, y:733, w:49, h:55}); 
			
			addStageElement({type:'toilet', x:928, y:988, w:56, h:68, thoughtType:'toilet', objectType:"immobile"});
...
/* THOUGHT ANIMATIONS*/
			addThoughtElement({name:'candle', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/candleThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'lampBR', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/lampBRThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'lampOffice', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/lampOfficeThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			...
			addThoughtElement({name:'chairBar', x:8, y:8, w:157, h:116, frameCount:6, frameRoot:"/img/gameDev/chairBarThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'chairTable', x:8, y:8, w:157, h:116, frameCount:4, frameRoot:"/img/gameDev/chairTableThought/animation", frameType:".gif", className:"animationSequence"});
			addThoughtElement({name:'matCorner', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/matCornerThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'kitchenSink', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/kitchenSinkThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'kitchenRange', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/kitchenRangeThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			...
			addThoughtElement({name:'lampLR', x:8, y:8, w:157, h:116, frameCount:4, frameRoot:"/img/gameDev/lampLRThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'toilet', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/toiletThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'bathtub', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/bathtubThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'bathSink', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/bathSinkThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'sock', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/sockThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'underwear', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/underwearThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'shirt', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/shirtThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			addThoughtElement({name:'pant', x:8, y:8, w:157, h:116, frameCount:3, frameRoot:"/img/gameDev/pantThought/animation", frameType:".gif", className:"animationSequence"}); //complete
			...
			var volumeControlInfo = {type:'volumeControl', x:0, y:0, w:42, h:39, buttonFunction:"toggleAudio"};
			...
			var gameBoardImageLookup = {
									...
									bathroomSink:["/img/gameDev/bathroomSinkOff.gif","/img/gameDev/bathroomSinkOn.gif"],
									bathroomSinkFixtures:"/img/gameDev/bathroomSinkFixtures.gif",
									toilet:["/img/gameDev/toiletOff.gif","/img/gameDev/toiletOn.gif"],
									toiletBack:"/img/gameDev/toiletBack.gif",
									...
									volumeControl:["/img/gameDev/volumeOn.gif","/img/gameDev/volumeOff.gif"],
									sidewalk:"/img/gameDev/emptyShim.gif",
									exitGameBlocker:"/img/gameDev/emptyShim.gif",
									finishText:"/img/gameDev/finish.gif",
									dirt:"/img/gameDev/emptyShim.gif",
									shrubbery:"/img/gameDev/emptyShim.gif",
									loading:"/img/gameDev/loading.gif"
