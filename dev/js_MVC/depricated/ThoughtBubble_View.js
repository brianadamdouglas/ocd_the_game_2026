var ThoughtBubble_View = Tile_View.extend({
  construct: function() { 
  		this.SC.construct();
  		
  		this._baseImageController;
  		this._imagesController;
  		this._images;
  		this._animations;
		this._OCDReference;
  ...
  */    
   addAnimationSequence: function(name, id, className, x, y, width, height, imgs, startFrame){
       ...
       //Add AnimationSequence_Controller
       //Add AnimationSequence_View
