...
*/
var Player_OCD_Controller = Player_Controller.extend({
construct: function() { 
	this.SC.construct();
...
addListners:function(){
	...
	g_eventHandler.addAListener("walk", this);
	g_eventHandler.addAListener("stopWalk", this);
	g_eventHandler.addAListener("startWalk", this);
	g_eventHandler.addAListener("startTurnRight", this);
	g_eventHandler.addAListener("startTurnLeft", this);
},
...
* @return null
*/
bindHitTestHeadView: function(view, data){
...
* @return null
*/
bindHitTestTorsoView: function(view, data){
