...
generateThoughtInfo:function(){
	this._thoughtInfo = {type:'thoughtBubble', x:this._rotaterX - 87, y:this._rotaterY - 215, w:173, h:158, stickyHoldingOffset:{0:[0,0], 90:[0,0], 180:[0,0], 270:[0,0]}};
},
...
generateStartScreenElements:function (){
	...
	this.addStartScreenElement({type:'loading', x:(paddingX + 120), y:(paddingY + 342), w:154, h:23, IDOverride:"loading"});
	this.addStartScreenElement({type:'startButton', x:(paddingX + 139), y:(paddingY + 342), w:90, h:23, IDOverride:"start", buttonFunction:"startGame"});
	...
	this.addStartScreenElement({type:'disclaimerButton', x:(paddingX + 96), y:(paddingY + 444), w:175, h:23, IDOverride:"disclaimer", buttonFunction:"openDisclaimer"});
	this.addStartScreenElement({type:'trademark', x:(paddingX + 31), y:(paddingY + 493), w:306, h:39});
