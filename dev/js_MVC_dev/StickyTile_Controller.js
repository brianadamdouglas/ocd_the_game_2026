var StickyTile_Controller = OnOffTileControl_Controller.extend({ // stickTile instances are able to be picked up by the player and placed by the player
construct: function() { 
	this.SC.construct();
...
* @param {Object} rect
*/ 
setDroppedRect: function(rect, rotation, player) {
  var top = 0;
  var right = 0;
  var bottom = 0;
  var left = 0;
...
*/   
stickToPlayer: function(rect, rotation, player){
